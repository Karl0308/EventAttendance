...
{
    /// <inheritdoc />
    public partial class Section4Baseline : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZone = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false, defaultValue: "Asia/Manila"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReaderModel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Devices_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SisExternalId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RfidCards_Schools_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "Schools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceMode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Single"),
                    GraceMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    RequireRegistration = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Draft"),
                    OrganizerUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsertedRows = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    UpdatedRows = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SisImportBatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SisImportBatches_Schools_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "Schools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SisImportBatches_Users_RunByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EventGroups_GroupOrStudent", "([StudentGroupId] IS NULL AND [StudentId] IS NOT NULL) OR ([StudentGroupId] IS NOT NULL AND [StudentId] IS NULL)");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventGroups_StudentGroups_StudentGroupId",
                        column: x => x.StudentGroupId,
                        principalTable: "StudentGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventGroups_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OccurrenceStartAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OccurrenceEndAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SisImportRows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SisImportRows_SisImportBatches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "SisImportBatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SisImportRows_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CaptureMethod = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Rfid"),
                    DeviceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DeviceTapId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_EventSchedules_OccurrenceId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_RfidCards_RfidCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendance_EventId_Status",
                table: "AttendanceRecords",
                columns: new[] { "EventId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_OccurrenceId",
                table: "AttendanceRecords",
                column: "OccurrenceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_RfidCardId",
                table: "AttendanceRecords",
                column: "RfidCardId");
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Attendance_Event_Student_Occurrence",
                table: "AttendanceRecords",
                columns: new[] { "EventId", "StudentId", "OccurrenceId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_SchoolId",
                table: "Devices",
                column: "SchoolId");

            migrationBuilder.CreateIndex(
                name: "UX_Devices_ApiKey",
                table: "Devices",
                column: "ApiKey",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventGroups_StudentGroupId",
                table: "EventGroups",
                column: "StudentGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_EventGroups_StudentId",
                table: "EventGroups",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "UX_RfidCards_SchoolId_CardUid_Active",
                table: "RfidCards",
                columns: new[] { "SchoolId", "CardUid" },
                unique: true,
                filter: "[IsActive] = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SisImportBatches_RunByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SisImportRows_StudentId",
                table: "SisImportRows",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "UX_StudentGroupMembers_Group_Student",
                table: "StudentGroupMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_SisExternalId",
                table: "Students",
                column: "SisExternalId");
            ...
            migrationBuilder.CreateIndex(
                name: "UX_SystemSettings_SchoolId_Key",
